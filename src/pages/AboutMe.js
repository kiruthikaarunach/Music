    ...
    <Box p={2}>
      ...
      <div className="guru-section">
          ...
          <div className="guru-column">
            ...
            Music has always been her passion. She values music deeply and respects it equivalent to God, loving to teach students with great reverence.
      ...
      {/* Fourth section */}
        ...
        <div className="guru-section">
          ...
          <div className="centered-text">
              ...
              <i className="fas fa-music"></i>
              She learns film music from famous Vijay TV Super Singer and Jaya Super Singer Winner and Playback Singer Keshav Vinod.He is such a gem of musicians currently pursuing PHD in music.
              <i className="fas fa-heart"></i>
          </div>
</div>
          {/* Right column for photos */}
